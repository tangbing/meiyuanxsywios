//
//  CLGroupBuyRefundReasonCell.swift
//  MeiYuanXSYW
//
...
class CLGroupBuyRefundReasonCell: XSBaseTableViewCell {
    
    var clickBlock:((_ para:String)->())?
    
    var model:[String] = ["计划有变,没时间消费","买多了","有优惠券没用","店铺活动更便宜","其他平台更便宜","联系不上商家","食品问题"]
...
extension CLGroupBuyRefundReasonCell : UITableViewDataSource ,UITableViewDelegate{
